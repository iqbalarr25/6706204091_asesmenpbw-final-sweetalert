                            ...
                            <form action="{{ route('novel.store') }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="grid lg:grid-cols-2 gap-4">
                                    ...
                                    <div>
                                        ...
                                        <x-input id="isbn" class="block mt-1 w-full" type="text" name="isbn" :value="old('emp_id')" required autofocus />
                                    </div>

                                    <!-- Name -->
                                    <div>
                                        <x-label for="judul" :value="__('Judul')" />
                                        <x-input id="judul" class="block mt-1 w-full" type="text" name="judul" :value="old('judul')" required />
                                    </div>

                                    <!-- penulis -->
                                    <div class="mt-4">
                                        <x-label for="penulis" :value="__('Penulis')" />
                                        <x-input id="penulis" class="block mt-1 w-full" type="text" name="penulis" :value="old('penulis')" required />
                                    </div>

                                    <!-- Email-->
                                    <div class="mt-4">
                                        <x-label for="penerbit" :value="__('Penerbit')" />
                                        <x-input id="penerbit" class="block mt-1 w-full" type="text" name="penerbit" :value="old('penerbit')" required />
                                    </div>

                                    <!-- phone-->
                                    <div class="mt-4">
                                        <x-label for="tahun_terbit" :value="__('Tahun terbit')" />
                                        <x-input id="tahun_terbit" class="block mt-1 w-full" type="number" name="tahun_terbit" :value="old('tahun_terbit')" required />
                                    </div>
